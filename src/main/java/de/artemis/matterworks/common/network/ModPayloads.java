...
public final class ModPayloads {
    ...
    public static void register(RegisterPayloadHandlersEvent event) {
        event.registrar(Matterworks.MOD_ID)
                ...
                .playToClient(SetMultiblockPortColorPayload.TYPE, SetMultiblockPortColorPayload.STREAM_CODEC, SetMultiblockPortColorPayload::handle)
                ...
                .playToServer(ClearMatterArchitectSelectionPayload.TYPE, ClearMatterArchitectSelectionPayload.STREAM_CODEC, ClearMatterArchitectSelectionPayload::handle)
